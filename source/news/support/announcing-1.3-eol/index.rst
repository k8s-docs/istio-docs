...
releases like 1.3 are supported for three months after the next LTS
release. Since `1.4 was released on November
14th </news/releases/1.4.x/announcing-1.4/>`_, support for 1.3 will end
on February 14th, 2020.

At that point we will stop back-porting fixes for security issues and
critical bugs to 1.3, so we encourage you to upgrade to the latest
